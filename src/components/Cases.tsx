        ...
        <div className="section_content text-white text-[18px]  ">
          <div>
            <div className="cases-text-block ">
              ...
              <p className="mb-3">
                We excel at removing news cases from the web
              </p>
              <p className="mb-3">
                Even if a story is posted on multiple news websites, we can
                manage it. For example, we recently removed 16 out of 18 news
                links related to a case that occurred four years ago. Our
                approach is always professional and discreet
              </p>
              <p className="mb-3">
            ...
            <div className=" count-price w-[100%] text-center btn-width-fix">
          ...
          {/* {window.innerWidth > 900 && (
            <div>
              <img src={illustration} alt="" className="w-[40vw]" />
            </div>
          )} */}
